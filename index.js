...
let mensagem = "Bem vindo ao metasdaily";
...
const listarMetas = async () => {
    ...
    const respostas = await checkbox({
        message: "Use as setas para mudar de meta, o espaço para marcar ou desmarcar e a tecla Enter para finalizar essa etapa",
        choices: [...metas],
        instructions: false,
    })
